(function() {
  ...
  DateRangePicker = (function() {
    ...
    DateRangePicker.prototype.initBindings = function() {
      ...
      $('body').click(function(evt) {           //点击隐藏或展开
    ...
    DateRangePicker.prototype.showCustomDate = function() {
      ...
      text = this.formatDate(this.startDate()) + ',' + this.formatDate(this.endDate());
			document.getElementById('startDate').value = this.formatDate(this.startDate());
			document.getElementById('endDate').value = this.formatDate(this.endDate());
    ...
    DateRangePicker.prototype.formatDate = function(d) {
		if(d.getDate()<10){
			return "" + (d.getFullYear().toString().substr(2, 2)) + "-" + (d.getMonth() + 1) + "-0" + (d.getDate());
		}
